...
namespace Net5.ChatRoom.API.Controllers
{
    ...
    public class UsersController : ControllerBase
    {
        ...
        {
            UserDto user = _chatApplicationService.GetUserByUserId(userId);
        ...
        public IActionResult UpdateUser(int userId, [FromBody] UserDto user)
        {
            ...
            if(user != null)
            {
                return CreatedAtAction("GetUserByUserId", new { userId = userId }, user);
            }
        ...
        public IActionResult DeleteUser(int userId)
        {
            ...
            UserDto user = _chatApplicationService.DeleteUser(userId);
