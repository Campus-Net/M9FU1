...
import { RoomForUpdate } from '../../../shared/models/room-for-update';
...
export class RoomsService {
  ...
  public editRoom(roomId: number,room:RoomForUpdate): Observable<Room> {    
    const updateUrl = `${this.roomsUrl}/${roomId}`;
    return this.http.put<Room>(updateUrl, room)
      .pipe(
        catchError(this.handleError)
      );
  }
