...
@Component({
  selector: 'app-bike-stores-manager',
  templateUrl: './bike-stores-manager.component.html',
  styleUrls: ['./bike-stores-manager.component.scss']
})
export class BikeStoresManagerComponent implements OnInit {
